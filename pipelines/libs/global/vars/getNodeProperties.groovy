...
def call(String node)
{
    ...
    node_env['fedora-39-x86-64'] = ['RUSTBINDINGS=yes']
    node_env['fedora-40-power9-ppc64le'] = ['RUSTBINDINGS=yes']
    node_env['fedora-40-s390x'] = ['RUSTBINDINGS=yes']
    ...
    node_env['rhel810z-power9-ppc64le'] = []
    node_env['rhel810z-s390x'] = []
    node_env['rhel810z-x86-64'] = []
