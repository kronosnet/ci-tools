...
def call(String node)
{
    ...
    node_env['fedora-43-power9-ppc64le'] = ['RUSTBINDINGS=yes']
    node_env['fedora-43-s390x'] = ['RUSTBINDINGS=yes']
    node_env['fedora-43-x86-64'] = ['RUSTBINDINGS=yes']
    node_env['fedora-44-x86-64'] = ['RUSTBINDINGS=yes']
    ...
    node_env['freebsd-15-x86-64'] = ['RUSTBINDINGS=yes', 'MAKE=gmake', 'PYTHON=/usr/local/bin/python3.11']
    ...
    node_env['ubuntu-26-04-lts-x86-64'] = []
