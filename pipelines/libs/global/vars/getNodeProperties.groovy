...
def call(String node)
{
    ...
    node_env['freebsd-12-x86-64'] = ['python=python3.9', 'QDEVICEDISTROCONFOPTS=--disable-systemd', 'USEGMAKE=1']
    node_env['freebsd-13-x86-64'] = ['python=python3.9', 'QDEVICEDISTROCONFOPTS=--disable-systemd', 'RUSTBINDINGS=yes', 'USEGMAKE=1']
    node_env['freebsd-devel-x86-64'] = ['python=python3.9', 'QDEVICEDISTROCONFOPTS=--disable-systemd', 'RUSTBINDINGS=yes', 'USEGMAKE=1']
