...
def call(String node)
{
    ...
    node_env['freebsd-12-x86-64'] = ['python=python3.9', 'MAKE=gmake']
    node_env['freebsd-13-x86-64'] = ['python=python3.9', 'RUSTBINDINGS=yes', 'MAKE=gmake']
    node_env['freebsd-devel-x86-64'] = ['python=python3.9', 'RUSTBINDINGS=yes', 'MAKE=gmake']
    node_env['jenkins-jumphost'] = []
    node_env['opensuse-15-x86-64'] = []
    node_env['opensuse-tumbleweed-x86-64'] = []
    node_env['rhel88z-power9-ppc64le'] = []
    node_env['rhel88z-s390x'] = []
    node_env['rhel88z-x86-64'] = []
    node_env['rhel8-ci-test-x86-64'] = []
    node_env['rhel8-coverity-x86-64'] = []
    node_env['rhel92z-power9-ppc64le'] = []
    node_env['rhel92z-s390x'] = []
