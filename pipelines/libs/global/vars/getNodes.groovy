...
{
    def labels = [:]
    labels['anvil-ci-bm-phy01'] = ['centos-8','stable','x86-64','rpm','yum','anvil-bm']
    labels['anvil-ci-bm-phy02'] = ['centos-8','stable','x86-64','rpm','yum','anvil-bm']
    ...
    labels['rhel89z-power9-ppc64le'] = ['rhel89z','stable','power9','ppc64le','voting','rpm','yum','nonvoting-clang','buildrpms', 'pcs-stable']
    labels['rhel89z-s390x'] = ['rhel89z','stable','s390x','voting','rpm','yum','nonvoting-clang','buildrpms', 'pcs-stable']
    labels['rhel89z-x86-64'] = ['rhel89z','stable','x86-64','voting','rpm','yum','nonvoting-clang','buildrpms', 'pcs-stable']
