...
def call()
{
    ...
    labels['fedora40-power9-ppc64le'] = ['fedora40','stable','power9-ppc64le','voting','rpm','yum','nonvoting-clang','buildrpms']
    labels['fedora40-s390x'] = ['fedora40','stable','x390x','voting','rpm','yum','nonvoting-clang','buildrpms']
    labels['fedora40-x86-64'] = ['fedora40','stable','x86-64','voting','rpm','yum','nonvoting-clang','buildrpms']
