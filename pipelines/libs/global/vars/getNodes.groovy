...
{
    def labels = [:]
    labels['tb-alpine-x86-64'] = ['alpine','unstable','x86-64','apk','nonvoting','nonvoting-clang']
    ...
    labels['anvil-ci-bm-phy02'] = ['almalinux-9','stable','x86-64','rpm','yum']
    ...
    labels['centos-10-power9-ppc64le'] = ['centos-10','stable','power9-ppc64le','voting','rpm','yum','nonvoting-clang','buildrpms']
    labels['centos-10-s390x'] = ['centos-10','stable','s390x','voting','rpm','yum','nonvoting-clang','buildrpms']
    labels['centos-10-x86-64'] = ['centos-10','stable','x86-64','voting','rpm','yum','nonvoting-clang','buildrpms']
    ...
    labels['fedora-44-power9-ppc64le'] = ['fedora-44','stable','power9-ppc64le','voting','rpm','yum','nonvoting-clang','buildrpms']
    labels['fedora-44-s390x'] = ['fedora-44','stable','x390x','voting','rpm','yum','nonvoting-clang','buildrpms']
    labels['fedora-44-x86-64'] = ['fedora-44','stable','x86-64','voting','rpm','yum','nonvoting-clang','buildrpms']
    ...
    labels['freebsd-15-x86-64'] = ['freebsd-15','stable','x86-64','voting','freebsd','nonvoting-clang']
    labels['freebsd-devel-x86-64'] = ['freebsd-devel','unstable','x86-64','nonvoting','freebsd','nonvoting-clang']
    labels['tb-openindiana-x86-64'] = ['openindiana','unstable','x86-64','nonvoting', 'nonvoting-clang']
    ...
    labels['ubuntu-26-04-lts-x86-64'] = ['ubuntu26.04','stable','x86-64','voting','apt','nonvoting-clang']
    labels['ubuntu-devel-x86-64'] = ['ubuntu-devel','unstable','x86-64','nonvoting','apt','nonvoting-clang']
    labels['vapor-driver-x86-64'] = ['rhel-9','stable','x86-64','yum', 'osp','aliyun','azure','aws','gcp','ocpv','ibmvpc','kbuild','kubesan-cache']
    labels['vapor-libvirt-1-x86-64'] = ['rhel-9','stable','x86-64','yum','libvirt','kubesan']
