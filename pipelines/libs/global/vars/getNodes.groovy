...
def call()
{
    ...
    labels['centos-10-power9-ppc64le'] = ['centos-10','unstable','power9-ppc64le','nonvoting','rpm','yum','nonvoting-clang','buildrpms']
    labels['centos-10-s390x'] = ['centos-10','unstable','s390x','nonvoting','rpm','yum','nonvoting-clang','buildrpms']
    ...
    labels['fedora-41-power9-ppc64le'] = ['fedora-41','stable','power9-ppc64le','voting','rpm','yum','nonvoting-clang','buildrpms']
    labels['fedora-41-s390x'] = ['fedora-41','stable','x390x','voting','rpm','yum','nonvoting-clang','buildrpms']
