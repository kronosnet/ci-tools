...
def call()
{
    ...
    labels['rhel9-vapor-rdu-3-x86-64'] = ['rhel9','stable','x86-64','yum','kbuild']
    ...
    labels['rhel9-vapor-rdu-6-x86-64'] = ['rhel9','stable','x86-64','yum','libvirtd']
    labels['rhel9-vapor-tlv-1-x86-64'] = ['rhel9','stable','x86-64','yum','ocpv']
