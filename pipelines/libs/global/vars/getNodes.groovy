...
def call()
{
    ...
    labels['freebsd-13-x86-64'] = ['freebsd-13','stable','x86-64','voting','freebsd','nonvoting-clang', 'test-nonvoting']
    ...
    labels['openindiana-x86-64'] = ['openindiana','unstable','x86-64','nonvoting', 'nonvoting-clang', 'test-nonvoting']
