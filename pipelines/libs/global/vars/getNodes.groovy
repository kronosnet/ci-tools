...
def call()
{
    ...
    labels['rhel-9-vapor-rdu-1-x86-64'] = ['rhel-9','stable','x86-64','yum','osp','azure','aws', 'gcp', 'ocpv','kubesan-cache']
    labels['rhel-9-vapor-rdu-2-x86-64'] = ['rhel-9','stable','x86-64','yum','osp','azure','aws', 'gcp', 'ocpv','kbuild']
