...
def call()
{
    ...
    providers['osp'] = ['maxjobs': 3, 'testlevel': 'all', 'rhelvers': ['8', '9'], 'has_watchdog': true, 'weekly': true]
    providers['libvirtd'] = ['maxjobs': 1, 'testlevel': 'all', 'rhelvers': ['7', '8', '9'], 'has_watchdog': true, 'weekly': false]
