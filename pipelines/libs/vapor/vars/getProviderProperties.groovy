...
def call()
{
    ...
    providers['libvirt'] = ['maxjobs': 4, 'testlevel': 'smoke', 'vers': ['rhel8', 'rhel9', 'rhel10', 'centos10'],
			    ...
			    'rhel8': ['createopts': "--image rhel-8.10.0.x86_64.qcow2 --flavor-workstation rhelha-vapor-workstation-medium --flavor rhelha-vapor-node-medium",
				      ...
				      'testopts': '',
				      'setup_fn': {}],
			    'rhel9': ['createopts': "--image rhel-9.6.0.x86_64.qcow2 --flavor-workstation rhelha-vapor-workstation-medium --flavor rhelha-vapor-node-medium",
				      'deployopts':  '',
				      'testopts': '',
				      'setup_fn': {}],
    ...
    providers['ocpv'] = ['maxjobs': 4, 'testlevel': 'all', 'vers': ['rhel8', 'rhel9', 'rhel10', 'centos10'],
			 ...
			 'defaultblocksize': '200',
			 'authopts': '',
			 'rhel8': ['createopts': '--flavor-workstation n1.2xlarge --flavor n1.2xlarge --block-emulation-type scsi --image rhel-8.10.0',
				   'deployopts':  '',
				   'testopts': '',
				   'setup_fn': {}],
			 'rhel9': ['createopts': '--flavor-workstation n1.2xlarge --flavor n1.2xlarge --block-emulation-type scsi --image rhel-9.6.0',
				   'deployopts':  '',
				   'testopts': '',
				   'setup_fn': {}],
			 'rhel10': ['createopts': '--flavor-workstation n1.2xlarge --flavor n1.2xlarge --block-emulation-type scsi --image rhel-10.0.0',
				    'deployopts':  '',
				    'testopts': '',
				    'setup_fn': {}],
			 'centos10': ['createopts': '--flavor-workstation n1.2xlarge --flavor n1.2xlarge --block-emulation-type scsi --image centos-10-stream',
				      'deployopts':  '',
				      'testopts': '',
				      'setup_fn': {}]]
